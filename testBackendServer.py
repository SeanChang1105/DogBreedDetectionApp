...
file_path_to_img = "/data/lam138/DogIdentification/DogIdentification_S24/CNN/DogDataset/testing_data/golden_retriever/gr76.jpg" # Change this to the file path of the image you want to upload to the server
